import{a as s,i as o}from"./theme-BJJ86vkc.js";s();const a=document.querySelector("#app");a.innerHTML=`
...
`;o(document.querySelector("#theme-toggle"));document.querySelectorAll(".code-block-wrap").forEach(t=>{const i=t.querySelector("pre");if(!i)return;const e=document.createElement("button");e.className="copy-btn",e.textContent="Copy",e.addEventListener("click",()=>{navigator.clipboard.writeText(i.innerText).then(()=>{e.textContent="Copied!",setTimeout(()=>{e.textContent="Copy"},1800)})}),t.appendChild(e)});
