    ...
    <div class="guide-step">
      ...
      <div class="question-list">
        <details class="question-block">
          <summary>If you increase the temperature of the fluid, what do you predict happens to how far the particle wanders?</summary>
        ...
        <details class="question-block">
          <summary>If you watch two particles starting from the same spot, do you expect them to end up in the same place after 10 seconds? Why or why not?</summary>
          <div class="answer-body">
...
y[0] = 0.0</pre>
      ...
      <div class="question-list">
        <details class="question-block">
          <summary>Why do you set <code>x[0] = 0.0</code> separately, outside the loop? What would happen if you forgot to set an initial condition?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>You allocated the full array <em>before</em> the loop rather than building it up step by step. Why might that be a good habit?</summary>
          <div class="answer-body">
...
plt.show()</pre>
      ...
      <div class="question-list">
        <details class="question-block">
          <summary>Describe what the plot looks like. Does it resemble the wandering path of a particle in a fluid?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>Where does the path appear to be centred, regardless of how many steps you run? Why?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>What is the particle "forgetting" between each step?</summary>
          <div class="answer-body">
  ...
  <section class="panel lesson-group">
    ...
    y[i] = y[i-1] + np.random.normal(0, sigma)</pre>
      ...
      <div class="question-list">
        <details class="question-block">
          <summary>What does <code>x[i-1]</code> contribute? In plain language, what is it doing for the simulation?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>Run the script a few times without changing anything. Does the path look the same each time? Why or why not?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>The particle starts at (0, 0). After 1000 steps, roughly how far from the origin does it end up? Run it five times and note the distances.</summary>
          <div class="answer-body">
  ...
  <section class="panel lesson-group">
    ...
    <div class="guide-step">
      ...
      <div class="question-list">
        <details class="question-block">
          <summary>Every simulation in this series uses Euler's method. Based on what you have seen so far, what two things do you need to know to apply it to any system?</summary>
          <div class="answer-body">
...
plt.show()</pre>
      ...
      <div class="question-list">
        <details class="question-block">
          <summary>Do the two particles ever end up in the same place at the end of the simulation? Would you expect them to?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>Now imagine doing this for 10 particles. How many arrays would you need to declare? How many lines would the loop body have?</summary>
          <div class="answer-body">
  ...
  <section class="panel lesson-group">
    ...
    <div class="guide-step">
      ...
      <div class="question-list">
        <details class="question-block">
          <summary>For 10 particles written long-form, how many lines does the loop body contain?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>What would you have to change in the script to go from 10 particles to 11? Is there a better way?</summary>
          <div class="answer-body">
...
plt.show()</pre>
      ...
      <div class="question-list">
        <details class="question-block">
          <summary><code>x</code> now has shape <code>(N, n_particles)</code>. What does <code>x[i]</code> refer to? What does <code>x[:, p]</code> refer to?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary><code>np.random.normal(0, sigma, n_particles)</code> draws <code>n_particles</code> random numbers at once. Why is that important here?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>Change <code>n_particles</code> to 500. How does the cloud of end-points look compared to 10 particles? What shape does it approach?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>Change <code>sigma</code> from <code>0.5</code> to <code>0.1</code>. How does the spread of end-points change? Try <code>sigma = 2.0</code>.</summary>
          <div class="answer-body">
  ...
  <section class="panel lesson-group">
    ...
    <div class="guide-step">
      <div class="question-list">
        <details class="question-block">
          <summary>Explain in your own words why <code>x[i] = np.random.normal(0, sigma)</code> does not produce Brownian motion, but <code>x[i] = x[i-1] + np.random.normal(0, sigma)</code> does.</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>What are the two ingredients of Euler's method? Write the general update rule in words (not code).</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>In the final script, the loop body is two lines regardless of how many particles you simulate. Why? What feature of NumPy makes this possible?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>A classmate argues: "We should set <code>x[0, :] = 0</code> inside the loop at <code>i = 0</code> rather than outside it." What is wrong with this argument?</summary>
          <div class="answer-body">
        ...
        <details class="question-block">
          <summary>In theory, the root-mean-square distance a particle travels from the origin after <code>N</code> steps of size <code>sigma</code> is approximately <code>sigma × √N</code>. With <code>sigma = 0.5</code> and <code>N = 1000</code>, what does this predict? Check it roughly by eye using your 500-particle simulation.</summary>
          <div class="answer-body">
